        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                href="#"
                onClick={() => navigateTo('/genres')} // Gunakan rute Inertia.js
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li>
              <a
                href="#"
                onClick={() => navigateTo('/actors')} // Gunakan rute Inertia.js
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li>
              <a
                href="#"
                onClick={() => navigateTo('/comments')} // Gunakan rute Inertia.js
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li>
              <a
                href="#"
                onClick={() => navigateTo('/awards')} // Gunakan rute Inertia.js
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li>
              <a
                href="#"
                onClick={() => navigateTo('/users')} // Gunakan rute Inertia.js
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ms-3 whitespace-nowrap">CMS User</span>
              </a>
            </li>
            <li>
              <a
                href="#"
                onClick={() => navigateTo('/filmcms')} // Gunakan rute Inertia.js
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="flex-1 ms-3 whitespace-nowrap">CMS Film</span>
              </a>
            </li>
          </ul>
        </div>
